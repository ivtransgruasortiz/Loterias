...
#  Notas: Para parejas poner lengh en 2, y para trios poner length en3 y support inferior a 0.005
...
columnas_b = ['bola_1',
              ...
              'estrella1',
              'estrella2']
euromillones1.columns = columnas_b
...
# Parejas
f = frequent_itemsets1[(frequent_itemsets1['length'] == 2) & (frequent_itemsets1['support'] >= 0.015)]
f.sort_values('support', ascending=False).head(60)

# # Trios
# f = frequent_itemsets1[(frequent_itemsets1['length'] == 3) & (frequent_itemsets1['support'] >= 0.003344)]
# f.sort_values('support', ascending=False).head(60)
...
f = frequent_itemsets2[(frequent_itemsets2['length'] == 2) & (frequent_itemsets2['support'] >= 0.025)]
f.sort_values('support', ascending=False).head(60)
